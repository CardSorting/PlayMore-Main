<div class="bg-white overflow-hidden shadow-sm rounded-lg">
    ...
    <div class="p-2 bg-gray-50 border-t space-y-2">
        <div class="flex justify-between gap-2">
            ...
            @if($currentTab === 'create')
                @if($hasCard)
                    <div class="w-full flex items-center justify-center px-3 py-1.5 bg-gray-200 text-gray-500 text-sm font-medium rounded cursor-not-allowed transition-all duration-200 ease-in-out"
                ...
                @else
                    <a href="{{ route('cards.create', ['image_id' => $image->id]) }}"
                       class="w-full flex items-center justify-center px-3 py-1.5 bg-purple-500 text-black text-sm font-medium rounded hover:bg-purple-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-purple-500 transition-all duration-200 ease-in-out"
            ...
            @else
                <a href="{{ route('prints.create', ['gallery' => $image->id]) }}"
                   class="w-full flex items-center justify-center px-3 py-1.5 bg-blue-500 text-white text-sm font-medium rounded hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-all duration-200 ease-in-out"
