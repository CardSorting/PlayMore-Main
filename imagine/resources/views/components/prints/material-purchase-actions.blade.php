...
<div x-data="{ 
    selectedSize: '{{ old('size', $selectedSize ?? '') }}',
        ...
        <div class="border-t border-gray-200 px-6 py-4">
            ...
            <div class="space-y-3 pt-4">
                ...
                <button type="submit"
                        ...
                        value="true"
                        class="flex w-full items-center justify-center rounded-md border border-transparent bg-gray-900 px-6 py-3 text-base font-medium text-white shadow-sm hover:bg-gray-800 focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-offset-2">
